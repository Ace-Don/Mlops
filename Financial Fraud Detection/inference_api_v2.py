...
def load_model() -> bool:
    ...
    try:
        ...
        try:
            ...
            # trained_model — the artifact name, not the ZenML model name
            latest_versions = mlflow_client.get_latest_versions("trained_model")

            if latest_versions:
                latest    = latest_versions[0]
                model_uri = f"runs:/{latest.run_id}/trained_model"
