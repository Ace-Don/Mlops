...
def model_evaluator(
    ...
    tst_precision = precision_score(y_tst, y_tst_pred, average="binary", zero_division=0)
    tst_recall = recall_score(y_tst, y_tst_pred, average="binary", zero_division=0)
    tst_f1 = f1_score(y_tst, y_tst_pred, average="binary", zero_division=0)
    ...
    client = Client()
    latest_classifier = client.get_artifact_version("trained_model")
