...
# 
# Copyright (c) Donald 2026. All rights reserved.
# 
...
def inference_predict(
    ...
    if predictor_service is not None and predictor_service.is_running:
        ...
        logger.warning(
            ...
            "as the deployment service is not running locally."
        )
